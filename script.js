...
/* ZAPPY_FAITHFUL_MOTION_RUNTIME_V1 */
(function () {
  'use strict';
  ...
  if ('IntersectionObserver' in window) {
    ...
    var observer = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        ...
        entry.target.style.transform = entry.target.getAttribute('data-zappy-static-transform') || 'none';
  ...
  nodes.filter(function (el) { return el.getAttribute('data-zappy-motion') === 'hero-layer'; })
    .forEach(function (el, index) {
      ...
      el.animate([
        ...
        { transform: stable + ' translate3d(' + (depth % 2 ? 8 : -8) + 'px,' + (-5 - depth * 2) + 'px,0) rotate(' + (depth % 2 ? 1 : -1) + 'deg)' },
        { transform: stable + ' translate3d(0,0,0) rotate(0deg)' }
      ], { duration: 3600 + depth * 420, iterations: Infinity, easing: 'ease-in-out' });
    });
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '87a7db1a-abde-499d-ad18-9f7b39292118',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '87a7db1a-abde-499d-ad18-9f7b39292118';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '87a7db1a-abde-499d-ad18-9f7b39292118';
